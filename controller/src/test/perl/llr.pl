...
sub usage {
   print STDOUT "usage: llr.pl -<b or r> -h <host> -p <port> -t <timeout> -s <subscriber file> -c <conference file>\n";
   print STDOUT "\n\t\t -b is for backup.\n";
   print STDOUT "\n\t\t -r is for restore.\n";
