...
public class MuteParticipantServletTest extends ListenServletTest
{
    private MuteParticipantServlet servlet = new MuteParticipantServlet();
    ...
    @Test
    public void test_doPost_tryingToMuteAdminParticipant_throwsListenServletExceptionWithUnauthorizedStatusWithTextPlainContent()
        throws IOException, ServletException
    {
        ...
        testForListenServletException(servlet, HttpServletResponse.SC_UNAUTHORIZED,
                                      "Unauthorized - Not allowed to mute participant");
    }
