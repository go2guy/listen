...
public class StopRecordingServletTest extends ListenServletTest
{
    private StopRecordingServlet servlet = new StopRecordingServlet();
        ...
        throws IOException, ServletException
    {
        ...
        testForListenServletException(servlet, HttpServletResponse.SC_UNAUTHORIZED,
                                      "Unauthorized - Not allowed to stop recording");
    }
