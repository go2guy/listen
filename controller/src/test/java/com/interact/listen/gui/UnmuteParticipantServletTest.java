...
public class UnmuteParticipantServletTest extends ListenServletTest
{
    private UnmuteParticipantServlet servlet = new UnmuteParticipantServlet();
        ...
        throws IOException, ServletException
    {
        ...
        testForListenServletException(servlet, HttpServletResponse.SC_UNAUTHORIZED,
                                      "Unauthorized - Not allowed to unmute participant");
    }
