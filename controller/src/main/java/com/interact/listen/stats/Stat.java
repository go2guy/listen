...
public enum Stat
{
    ...
    API_CALLDETAILRECORD_DELETE(null),
    API_CALLDETAILRECORD_GET(null),
    API_CALLDETAILRECORD_POST(null),
    API_CALLDETAILRECORD_PUT(null),
    ...
    GUI_DISABLE_USER(StatId.LISTEN_CONTROLLER_GUI_DISABLE_USER),
    ...
    GUI_EDIT_USER(StatId.LISTEN_CONTROLLER_GUI_EDIT_USER),
    GUI_GET_CALLHISTORY_LIST(null), // FIXME
    ...
    GUI_GET_USER(null), // FIXME
    GUI_GET_USER_LIST(StatId.LISTEN_CONTROLLER_GUI_GET_USER_LIST),
