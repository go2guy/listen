...
public enum Stat
{
    ...
    GUI_DELETE_ATTENDANT_MENU(null), // FIXME
    ...
    GUI_GET_ATTENDANT_MENU_LIST(null), // FIXME
    ...
    GUI_GET_SCHEDULED_CONFERENCE_LIST(null), // FIXME
    ...
    GUI_SAVE_ATTENDANT_MENU(null), // FIXME
