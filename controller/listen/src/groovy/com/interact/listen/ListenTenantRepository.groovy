 ...
 * @author Kim A. Betti
 */
public class ListenTenantRepository implements CurrentTenantAwareRepository {
    ...
    {
        Organization thisOrg = Organization.get(tenantId);
        return User.findByOrganization(thisOrg);
    }
}