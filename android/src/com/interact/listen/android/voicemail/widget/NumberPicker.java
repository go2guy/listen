...
public class NumberPicker extends LinearLayout
{
    ...
    public interface OnChangedListener
    {
         ...
         */
        void onNumberChanged(NumberPicker picker, int oldVal, int newVal);
    }
    ...
    public NumberPicker(Context context, AttributeSet attrs)
    {
        ...
        {
            /**
             * We start the long click here but rely on the {@link NumberPickerButton} to inform us when the long click
             * has ended.
             */
            public boolean onLongClick(View v)
            {
                /*
                 * The text view may still have focus so clear it's focus which will trigger the on focus changed and
                 * any typed values to be pulled.
                 */
                mText.clearFocus();
     ...
     * 
     * @param formatter the formatter object. If formatter is null, String.valueOf() will be used
     */
     ...
     * @throws IllegalArgumentException when current is not within the range of of the number picker
     */
    ...
    /**
     * Sets the speed at which the numbers will scroll when the +/- buttons are longpressed
     * 
     * @param speed The speed (in milliseconds) at which the numbers will scroll default 300ms
     */
    ...
    /**
     * Sets the current value of this NumberPicker, and sets mPrevious to the previous value. If current is greater than
     * mEnd less than mStart, the value of mCurrent is wrapped around. Subclasses can override this to change the
     * wrapping behavior
     * 
    ...
    private void notifyChange()
    {
        if(mListener != null)
        {
            mListener.onNumberChanged(this, mPrevious, mCurrent);
        }
    }

    /**
     * Updates the view of this NumberPicker. If displayValues were specified in {@link #setRange}, the string
     * corresponding to the index specified by the current value will be returned. Otherwise, the formatter specified in
    ...
    private int getSelectedPos(String str)
    {
        if(mDisplayedValues == null)
        {
            ...
            {
                Log.v("NumberPicker", "ignoring non number");
            }
        }
        else
        {
